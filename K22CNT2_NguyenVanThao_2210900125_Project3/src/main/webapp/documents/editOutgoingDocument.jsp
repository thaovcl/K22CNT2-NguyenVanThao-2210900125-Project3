...
<%@ page import="model.DocumentOutgoing" %>
<%
    DocumentOutgoing doc = (DocumentOutgoing) request.getAttribute("document");
%>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Chỉnh sửa công văn đi</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form action="update-document" method="post" enctype="multipart/form-data">
            ...
            <label for="sentDate">Ngày gửi:</label>
            <input type="date" id="sentDate" name="sentDate" value="<%= doc.getSentDate() %>" required>
            ...
            <div class="btn-container">
                ...
                <a href="outgoing-documents" class="btn btn-secondary">Hủy</a>
            </div>
        </form>
    </div>
</body>
