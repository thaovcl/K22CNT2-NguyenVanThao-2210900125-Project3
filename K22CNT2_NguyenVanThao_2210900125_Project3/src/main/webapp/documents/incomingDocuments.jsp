	...
	<body>
	    <div class="container">
	        <div class="header">
	            <h1>Công Văn Đến</h1>
	            <p>Quản lý công văn đến trong hệ thống</p>
	        </div>
	        <div class="mb-3 text-center">
	            <a href="documents/addIncomingDocument.jsp" class="btn btn-primary">Thêm Công Văn</a>
	        ...
	        <table class="table table-bordered table-striped table-hover">
	            ...
	            <tbody>
	                ...
	                <tr>
	                    ...
	                    <td>
	                        <a href="edit-incoming-document?id=<%= doc.getId() %>" class="btn btn-warning">Sửa</a>
